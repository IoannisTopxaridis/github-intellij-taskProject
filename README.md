...
* Μόλις ολοκληρωθεί, η JavaScript καθαρίζει το πεδίο με το κείμενο που δόθηκε από τον χρήστη και ανανεώνει και εμφανίζει αυτόματα τη λίστα στην οθόνη.
...
* Η MySQL διαγράφει το task με αυτό το ID, και το Front-end καλεί αυτόματα την `getTaskFromServer()` για να ενημερωθεί η λίστα που εμφανίζεται στον χρήστη.
